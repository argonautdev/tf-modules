...
terraform {
  ...
  # source = "git::git@github.com:argonautdev/tf-modules.git//modules/aws/s3StaticSite?ref=v0.3.0"
  source = "../../../../../..//modules/aws/s3StaticSite"
}
...
inputs = {
  default_tags = {
    "argonaut.dev/name" = "ligmastaticsite"
  ...
  log_bucket_name = "ligmabucketlog"
